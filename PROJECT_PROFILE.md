...
| --------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Package manager and local runtime | [`package.json`](package.json), [`package-lock.json`](package-lock.json)                                                                                                                                           | npm `10.9.4`; Node engine `>=22.12.0`; current read-only command proof used Node `22.22.1`. No exact repository Node pin exists.                                                                                           |
| Hosted runtime                    | [Vercel project config](.vercel/project.json)                                                                                                                                                                      | TanStack Start project on Node `24.x`. This non-versioned environment-local configuration is not a fresh-checkout dependency or proof that local Node equals hosted Node.                                                  |
...
| CI                                | none                                                                                                                                                                                                               | No `.github/workflows` or other admitted repository CI command exists. Local proof is not CI parity.                                                                                                                       |
...
browser runner or CI workflow at this baseline. Specialized fixture/proof scripts remain
