...
- the visible onboarding UI now consumes the structured first-plan constructor contract:
  ...
  normal longer easy, steady, and long support runs are structured with clear opener/main/finish or equivalent purpose cues instead of defaulting to one anonymous main block; effort-only target-time plans therefore remain metric-safe without feeling like generic calendar filler
