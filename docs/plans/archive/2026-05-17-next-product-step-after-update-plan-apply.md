...
Reason: The update-plan apply track and later exact-draft/coaching hardening work are now QA-green; future next-step selection should start from current-state truth.
