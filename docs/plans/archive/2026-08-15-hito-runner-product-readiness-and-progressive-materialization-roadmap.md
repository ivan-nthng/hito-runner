...
| 1     | `runner-evidence-and-progress`     | Runner evidence is durably captured and Progress presents only supported personal facts, coverage, and comparisons.                                     | BACKEND -> FRONTEND Design System -> FRONTEND Product -> QA    | Evidence lifecycle, factual metric, chart/data-table, and missing-state acceptance pass.                 |
...
| —     | `platform-and-operations`          | Shared Design System, Admin tooling, reliability, release, and process work support the product without becoming a second product roadmap.              | FRONTEND Design System / BACKEND / FRONTEND / QA               | Bounded owner proof for each item.                                                                       |
