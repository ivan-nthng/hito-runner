...
- This plan was demoted from `docs/plans/active` during the 2026-06-15 global teardown audit
  because advanced/performance cadence is future coaching doctrine, not current implementation.
...
Moved from active plans to backlog during the 2026-06-15 global teardown audit. This remains a valid
future Running Coach doctrine item, but it is not an active implementation owner and should not be
used to justify runtime bloat during code-freeze cleanup.
