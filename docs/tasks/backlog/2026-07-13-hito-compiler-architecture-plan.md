...
- **Residual boundary:** This architecture is accepted and closed. Universal load/progression veto policy remains outside it until PRODUCT and RUNNING COACH define that contract. Post-confirm workout editability follows current product policy…
