...
- **Residual boundary:** Keep HITO_TYPOGRAPHY_ROLES as the sole 19-role inventory and the existing 14-role selectable subset. Preserve inherited --hito-typography-role provenance; computed values and visual similarity do not confirm ownership…
