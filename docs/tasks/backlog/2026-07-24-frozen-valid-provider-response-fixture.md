...
- **Residual boundary:** No production provider fallback, Admin persistence, or runner-data mutation. Valid fixture data is local validation infrastructure, not product truth or an alternate planner. Keep invalid historical evidence for…
