...
- **Residual boundary:** Keep fixture-only behavior local, gated, non-persisting, and provider-free. Do not change Garmin ingestion, API routes, deterministic comparison truth, real upload/remove lifecycle, signed plans, or shared Hito DS…
