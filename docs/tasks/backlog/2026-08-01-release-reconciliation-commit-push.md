...
- **Residual boundary:** Do not delete QA artifacts, logs, caches, dependencies, or history merely because they are old. Do not include secrets, generated build output, local credentials, or proof artifacts in commits. Do not call a provider…
