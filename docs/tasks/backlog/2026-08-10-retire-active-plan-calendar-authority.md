...
- **Sources:** [training-api.ts](../../../src/lib/training-api.ts); [active-plan-persistence.ts](../../../src/lib/active-plan-persistence.ts); the removed source-capability implementation remains in Git history.
