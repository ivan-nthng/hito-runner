...
- **Residual boundary:** No blocker remains for this deletion sweep. The held semantic-color fallback is a separate token-display/Figma-adjacent contract decision and was not hidden or expanded into this task. This completion is focused Design…
