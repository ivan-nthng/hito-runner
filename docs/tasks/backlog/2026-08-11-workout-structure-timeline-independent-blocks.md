...
- **Residual boundary:** | Rendered visual/interaction proof | Authenticated desktop and exact 375×812, available themes | Not run | In-app browser URL policy blocked the DOM discriminator and prohibited an alternate browser-control…
