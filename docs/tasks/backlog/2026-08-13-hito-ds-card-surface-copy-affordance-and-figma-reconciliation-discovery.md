...
- **Residual boundary:** | DESIGN SYSTEM for board; DESIGN SYSTEM INTEGRATION for Figma | Collections are named, but file key/nodes and editable parity remain unverified.
