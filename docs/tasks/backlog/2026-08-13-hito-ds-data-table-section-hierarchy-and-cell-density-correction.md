...
- **Sources:** [reference-workbench.css](../../../src/styles/reference-workbench.css); [specimen-previews.tsx](../../../src/components/hito-ds/specimen-previews.tsx); [reference-components-controls.tsx](../../../src/components/hito-ds/reference-components-controls.tsx)
- **Validation:** Hierarchy, Comparison specimen, Containment and console passed as recorded in the terminal receipt; omitted layers remain outside this closeout.
- **Residual boundary:** Consequence: this receipt does not claim a globally green DS gate.
