...
const COMPONENT_SECTIONS = [
  ...
  { id: "button-group", label: "Grouped Buttons", keywords: ["connected", "composition"] },
  {
    id: "date-time",
    label: "Date & Time",
    keywords: ["date", "calendar", "time", "select", "workout type"],
  },
  {
    id: "inputs",
    label: "Inputs",
    keywords: ["field", "textarea", "range"],
  },
  { id: "metadata-tag", label: "Metadata Tag", keywords: ["tag", "chip", "label"] },
  {
    id: "reference-link",
    label: "Reference Link",
    keywords: ["anchor", "route", "used in", "reference", "deep link"],
  },
  {
    id: "native-select",
    label: "Workout Type Select",
    keywords: ["select", "option", "field", "branded"],
  },
