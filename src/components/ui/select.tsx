...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn("hito-ui-menu-label px-2 py-1.5", className)}
    {...props}
  />
));
