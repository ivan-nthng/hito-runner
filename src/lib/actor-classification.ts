...
export type ActorClassificationSource =
  | "none"
  | "local_accounts_file"
...
export interface ActorClassificationInfo {
...
export function classifyActor(input: ActorClassificationInput): ActorClassificationInfo {
