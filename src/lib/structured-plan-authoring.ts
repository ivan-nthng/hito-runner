...
function buildGeneratedWorkoutMetricMode(
...
function splitSubstantialEnduranceDuration(durationMin: number, minimumSplitMin: number) {
...
function buildDefaultEstimatedHrTarget(
  normalized: NormalizedStructuredInput,
