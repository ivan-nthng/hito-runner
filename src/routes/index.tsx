	...
	head: () => ({
		meta: [
			{ title: `${APP_NAME} — Weekly plan` },
			{
				name: "description",
				content:
					"Review your weekly running plan, persisted workout status, or the read-only preview baseline.",
			},
		],
	}),
	...
	return (
		<section className="mx-auto max-w-3xl rounded-2xl border border-hairline bg-gradient-to-br from-surface-elevated to-surface p-6 lg:p-10">
			...
			<p className="mt-4 max-w-xl text-sm text-muted-foreground leading-relaxed">
				We could open your saved mode, but no planned workouts are available to render on
				the calendar yet. Return to setup or refresh once the plan has been assigned.
			</p>
			...
			<div className="px-6 lg:px-10 py-20 max-w-2xl">
				<section className="rounded-2xl border border-destructive/30 bg-destructive/10 p-6 lg:p-10">
					...
					<p className="mt-4 text-sm text-foreground/85 leading-relaxed">
						Try again to reopen the latest saved or preview state. If setup is still
						incomplete, returning home will keep you in the onboarding flow.
					</p>
					<div className="mt-8 flex flex-wrap items-center gap-3">
						<button
							type="button"
